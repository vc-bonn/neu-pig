...
def read_parameters(parser):
    parser.add_argument('--conf', type=str, default='/data/kaltheuner/git/preconditioned-deformation-nets/ext/dynosurf/confs/base.conf')
    parser.add_argument('--input_file', type=str, default='/data/kaltheuner/CVPR_2026/related_work/dynosurf/120/crane_0/inputs.json')
    parser.add_argument('--logs_path', type=str, default='/data/kaltheuner/git/preconditioned-deformation-nets/ext/dynosurf/results')
